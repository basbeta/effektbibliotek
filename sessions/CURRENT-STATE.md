...
1. Utføre `docs/COOLIFY-DEPLOY.md` steg 1–6 i Coolify (database, app, domene, env-vars, backup, Uptime Kuma)
2. Ende-til-ende-test på `effektbibliotek.basbeta.no`: innlogging, case-opprettelse, godkjenningsflyt
